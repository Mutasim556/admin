            ...
            <div class="row">
                ...
                <div class="col-sm-6">
                    <ol class="breadcrumb">
                        ...
                        <li class="breadcrumb-item">{{ __('My Profile') }}</li>
                    </ol>
                </div>
            </div>
        </div>
            ...
            <div class="col-sm-5 mx-auto">
                <div class="card">
                    <div class="card-header pb-0">
                        <h4 class="text-center">{{ __('Profile Details') }}</h4>
                    ...
                    <div class="card-body">
                        ...
                        <div class="row">
                            <div class="col-lg-4">
                                <label for="" class="lebelcolor"><strong>{{ __('Email') }}</strong></label>
                            </div>
                            <div class="col-lg-8">
                        ...
                        <div class="row">
                            <div class="col-lg-4">
                                <label for="" class="lebelcolor"><strong>{{ __('Phone') }}</strong></label>
                            </div>
                            <div class="col-lg-8">
                        ...
                        <div class="row">
                            <div class="col-lg-4">
                                <label for="" class="lebelcolor"><strong>{{ __('Username') }}</strong></label>
                            </div>
                            <div class="col-lg-8">
                        ...
                        <div class="row">
                            <div class="col-lg-4">
                                <label for="" class="lebelcolor"><strong>{{ __('My role') }}</strong></label>
                            </div>
                            <div class="col-lg-8">
                                <label
                    ...
                    <div class="card-body" id="user_basic_edit" style="display: none">
                        <form class="theme-form" action="" id="update_basic_info_form" method="POST">
                            ...
                            <div class="row">
                                <div class="col-lg-4">
                                    <label for="" class="lebelcolor"><strong>{{ __('Name') }}</strong></label>
                                </div>
                                <div class="col-lg-8">
                            ...
                            <div class="row">
                                <div class="col-lg-12">
                                    <button type="submit" id="update_basic_info_button"
                                        class="btn btn-info form-control">{{ __('Update Profile Info') }}</button>
                                </div>
                            </div>
                    ...
                    <div class="card-body">
                        <form class="theme-form" action="" id="change_password_form" method="POST"
                            ...
                            <div class="row">
                                <div class="form-group col-md-4 py-0 my-0 ">
                                    <label for="" class="lebelcolor">{{ __('Old Password') }}</label>
                                </div>
                            ...
                            <div class="row">
                                <div class="form-group col-md-4 my-0">
                                    <label for="" class="lebelcolor">{{ __('New Password') }}</label>
                                </div>
                                <div class="input-group col-md-8 mb-3">
                            ...
                            <div class="row">
                                <div class="form-group col-md-4 my-0">
                                    <label for="" class="lebelcolor">{{ __('Re-type Password') }}</label>
                                </div>
                        ...
                        <span class="retype_password_error"></span>
                            ...
                            <button type="submit" id="update_password_button"
                                class="btn btn-success form-control">{{ __('Change Password') }}</button>
                        </form>
                        <script>
...
@push('js')
    ...
    <script src="{{ asset('admin/custom/admin_profile.js')}}"></script>
@endpush
