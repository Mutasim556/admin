...
@push('title')
    {{ __('admin_local.Department List') }}
@endpush
@push('css')
...
@section('content')
    <div class="container-fluid">
        <div class="page-title">
            <div class="row">
                <div class="col-sm-6">
                    <h3>{{ __('admin_local.Department List') }}</h3>
                </div>
                <div class="col-sm-6">
                    <ol class="breadcrumb">
                        <li class="breadcrumb-item">
                            <a href="javascript:void(0)">{{ __('admin_local.Department') }}</a>
                        </li>
                        <li class="breadcrumb-item active">{{ __('admin_local.Department List') }}</li>
                    </ol>
                </div>
            </div>
        </div>
                    ...
                    <form action="" id="add_department_form">
                        ...
                        <div class="row">
                            <div class="col-lg-12 mt-2">
                                <label for="department_name"><strong>{{ __('admin_local.Department Name') }} *</strong></label>
                                <input type="text" class="form-control" name="department_name" id="department_name">
                                <span class="text-danger err-mgs"></span>
                            </div>
                            <div class="col-lg-12 mt-2">
                                <label for="department_status"><strong>{{ __('admin_local.Department Status') }} *</strong></label>
    ...
    <div class="modal fade" id="edit-department-modal" tabindex="-1" aria-labelledby="bs-example-modal-lg" aria-hidden="true">
        <div class="modal-dialog modal-md">
            <div class="modal-content">
                <div class="modal-header d-flex align-items-center" style="border-bottom:1px dashed gray">
                    <h4 class="modal-title" id="myLargeModalLabel">
                        {{ __('admin_local.Edit Department') }}
                    </h4>
                    <button type="button" class="btn-close " data-bs-dismiss="modal" aria-label="Close"></button>
                </div>
                <p class="px-3 text-danger"><i>{{ __('admin_local.The field labels marked with * are required input fields.') }}</i>
            ...
            <div class="col-lg-11 mx-auto">
                <div class="card">
                    <div class="card-header py-3" style="border-bottom: 2px dashed gray">
                        <h3 class="card-title mb-0 text-center">{{ __('admin_local.Department List') }}</h3>
                    </div>
                    ...
                    <div class="card-body">
                        ...
                        <div class="table-responsive theme-scrollbar">
                            <table id="basic-1" class="display table-bordered">
                                <thead>
                                    <tr>
                                        <th>{{ __('admin_local.Department Name') }}</th>
